...
def sample(sample_size, noise):
    ...
    """
    mdp = MountainCarMDP(width=width, height=height, noise=noise)
...
def write_to_file(sample_size, noise):
    ...
    """
    output_dir = root_path + '/data/mountain_car/raw_{:d}_{:.0f}'.format(sample_size, noise)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='sample mountain car (gym) data')
